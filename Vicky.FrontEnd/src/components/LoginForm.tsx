...
export function LoginForm({ register, errors, isLoading, onSubmit }: LoginFormProps) {
    return (
        <div className="min-h-screen flex items-center justify-center bg-white">
            <div className="w-full max-w-md px-8 py-10 bg-white rounded-xl shadow-lg border border-gray-100">
                ...
                <h1 className="text-3xl text-center mb-2 text-gray-900">Welcome to Vicky</h1>
                <p className="text-center text-gray-500 mb-8">Login to manage your finances</p>
